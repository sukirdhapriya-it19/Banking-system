...
<div class="header">
<h5 style="padding-right: 1rem">Online Banking Serivice</h5>
</div>
<script>
function myFunction() {
...
while($row = $result->fetch_assoc()) {
    ...
    echo "<td ><a href='OneCustomer.php'><button type='submit'' name='user' class='expand'  id='users1' value= '{$row['name']}' ><span >Expand</span></button></a></td>";
    echo "</tr>";
}
echo "</table>";
} else { echo "0 results"; }
